...
// per product requirement. Once the user picks something, it is persisted.
...
const STORAGE_KEY_COLOR = "uwuflights.colorTheme";
const STORAGE_KEY_MODE = "uwuflights.mode";
